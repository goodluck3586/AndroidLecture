...
//                MediaPlayer.create(getApplicationContext(), R.raw.bell_sound2).start(); // 벨소리
                MediaPlayer mp = MediaPlayer.create(getApplicationContext(), R.raw.bell_sound2);
                ...
                countDownTimer = getCountDownTimer(fullTime);
        ...
        btnPauseRestart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(isPaused){
                    ...
                    countDownTimer = getCountDownTimer(Long.parseLong(btnTimerSwitch.getText().toString()));
                    countDownTimer.start();
                    isPaused = false;
                }else{
    ...
    private CountDownTimer getCountDownTimer(long t){
