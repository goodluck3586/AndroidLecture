...
//        menu.add(Menu.NONE, Menu.FIRST+2, Menu.NONE, "메뉴3");
        Menu sub = menu.addSubMenu(Menu.NONE, Menu.FIRST+2, Menu.NONE, "메뉴3");
        sub.add(Menu.NONE, Menu.FIRST+10, Menu.NONE, "서브메뉴1");
        sub.add(Menu.NONE, Menu.FIRST+20, Menu.NONE, "서브메뉴2");
        return true;
    }
